...
In this code, we take the raw CBP 1990 cleaned from Eckert, Fort, Schott and 
Yang (2021) to prepare the employment by sector dataset. 

Input files/base codes: 

1. other/cbp1990_imputations.do Replication package code to impute employment 
...
3. data/0-raw_data/cbp90st.txt EFCY CBP 1990 raw cleaned data at the state level. 

Output files: 
1. data/1-intermediate_data/cbp1990.dta Clean file with state, sector and 
employment.

*/

* Import the dataset
import delimited "../data/0-raw_data/cbp90st.txt", bindquote(strict) clear
...
keep statefip siccode2 emp

* Drop aggregate sectors (cbp1980_imputations.do)
#delimit ;
replace siccode2="." if siccode2=="----" | siccode2=="07--" | siccode2=="10--" 
| siccode2=="15--" | siccode2=="19--" | siccode2=="40--" | siccode2=="50--"
| siccode2=="52--" | siccode2=="60--" | siccode2=="70--" | siccode2=="99--" 
| siccode2=="098\" | siccode2=="149\" | siccode2=="179\" | siccode2=="399\"
| siccode2=="497\" | siccode2=="519\" | siccode2=="599\" | siccode2=="679\" 
| siccode2=="899\" | siccode2=="20--";
#delimit cr

drop if siccode == "." | siccode == "0000"

* Rename variables for consistency
rename siccode2 sic87
...
* Save final dataset
save ../data/1-intermediate_data/cbp1990.dta, replace
