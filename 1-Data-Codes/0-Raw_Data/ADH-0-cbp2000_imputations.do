...
import delimited "0-Raw_Data\ADH_employment\cbp00co\cbp00co.txt"
...
forvalues v=2/`x' {
   ...
   local sleep_1= 1500 + `v'
   local sleep_2= 2000 + `v'
   sleep `sleep_1'
...
gen yr=2000
sleep 1000  
save 1-Intermediate_Processed_Data/CBP_2000adj.dta, replace
