...
4) Combines the previous outputs, applies proportionality to ensure consistency with WIOD SEA
...
# Sector-State employment for 2000 from the 2000 Census

1. Construct employment levels for each US state from the 2000 Census. 
