...
#Trade distances
data_services <- read.csv("2-Final_Data\\data_services.csv")
...
#Trade distances
data_agriculture <- read.csv("2-Final_Data//data_agriculture.csv")
...
```{stata, collectcode=TRUE}
import delimited "1-Intermediate_Processed_Data//Country_Gravity_Agriculture_WIOD.csv"
