...
n.s <- 50
n.c <- 37
states=data.frame(Base.state$importer[1:n.s])
colnames(states) <- c("region")
countries=data.frame(Base.country$importer[1:n.c])
...
```{r}
states=(Base.state$importer[1:n.s])
countries=(Base.country$importer[1:n.c])
