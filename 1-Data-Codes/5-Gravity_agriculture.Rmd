...
2) This code generates the inputs of the gravity system in agriculture and solves the system.
...
7. `1-Intermediate_Processed_Data/state_country_step_y_.csv`
8. `1-Intermediate_Processed_Data/state_country_step_e_.csv`
9. Coefficients from `Country_Gravity_WIOD`
10. `1-Intermediate_Processed_Data/io_shares.csv`
11. `1-Intermediate_Processed_Data/labor_shares_countries.csv`
