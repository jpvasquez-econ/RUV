...
for (i in 2000:2007) {
  ...
  addWorksheet(wb, sheetName = sprintf("bilat_matrix_year%d", i))
  writeData(wb, sheet = sprintf("bilat_matrix_year%d", i), x = data)
}
...
writeData(wb, sheet = "va_shares_allyears", x = all)
saveWorkbook(wb, file = "2-Final_Data/Output.xlsx", overwrite = TRUE)
```
