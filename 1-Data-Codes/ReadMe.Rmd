 ...
 *1-Data-Codes/6-Matrices_deficits_VA_shares_states*
...
2) Calculate region-sector level deficits. 
...
3) Computes the exposure measure of equation (16) from the manuscript.
 - **Source:** `1-Data-Codes/0-Raw_Data`
and `1-Data-Codes/1-Intermediate_Processed_Data`
 - **Output:** `1-Data-Codes/1-Intermediate_Processed_Data` and `1-Data-Codes/2-Final_Data`
...
*1-Data-Codes/9-Migration_matrix*
...
## Trade deficits
Then script 6 calculates the deficit for a region $i$ in a sector $k$, defined as: 
