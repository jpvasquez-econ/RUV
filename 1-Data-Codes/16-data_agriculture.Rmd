...
if(abs(sum(check_2$production / check_1$total-1)>epsilon)) 
   stop(paste("states' production does not add to WIOD for", yr)) 
```
...
#agricultural expenditure for countries 
WIOD.c <- WIOD.full %>%
  filter(row_item==n.sec+2) %>%
