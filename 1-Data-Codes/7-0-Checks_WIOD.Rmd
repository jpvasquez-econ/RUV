...
if((sum(CDP.cc$val)/sum(wiot.cc$value) -1)>epsilon) 
...
if((sum(CDP.cs$val)/sum(wiot.cs$value) -1)>epsilon) 
...
if((sum(CDP.sc$val)/sum(wiot.sc$value) -1)>epsilon) 
...
if((sum(CDP.ss$val)/sum(wiot.ss$value) -1)>epsilon) 
