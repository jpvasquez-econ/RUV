...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gravity.us <- function( x, Lambda, Beta ) {  
######
###### CONSTRUCTING RHS
######
#Right hand side
...
####
#gravity.us(x,Lambda=lambda_vector,Beta=BIG.MAT) #seems to work!
...
optimal.model <- optimx( par=init, fn=gravity.us, Lambda=lambda_vector,Beta=BIG.MAT ,
...
optimal.model<-optim(par=init, fn=gravity.us, Lambda=lambda_vector,Beta=BIG.MAT ,
