...
# n.c <- 2; 
# n.s <- 2; 
# WIOD.base <- as.data.frame(matrix(0, n.c+1, 5+n.c)); 
# names(WIOD.base)<-c("year", "importer_country", "sector", "importer", "value_USA", "value_AUS", "value_AUT");
