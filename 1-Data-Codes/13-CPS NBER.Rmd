...
if(sum(abs(as.matrix(rowSums(check)) - matrix(1, dim(check)[1], 1))) > epsilon) 
  stop("mobility shares do not add to 1")
write.table(mu_1999_prime, file = paste("2-Final_Data/mu_1999_nber_case3_yearly.csv", sep=""), sep = ",", row.names = FALSE)
...
if(sum(abs(as.matrix(rowSums(check)) - matrix(1, dim(check)[1], 1))) > epsilon) 
  stop("mobility shares do not add to 1")
write.table(mu_1999_prime, file = paste("2-Final_Data/mu_1999_nber_case4_yearly.csv", sep=""), sep = ",", row.names = FALSE)
