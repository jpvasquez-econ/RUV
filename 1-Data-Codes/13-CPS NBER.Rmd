...
mu_1999_prime_q1 <- mu_1999_prime_q1 %>%
  ...
  mutate(state_dest_sector_dest = paste(state_dest, sector_dest, sep="_")) %>%
  select(-state_dest, -sector_dest)
mu_1999_q1 <- spread(mu_1999_prime_q1, state_dest_sector_dest, rel, fill = NA, convert = TRUE,  drop = TRUE, sep = NULL)
...
mu_1999_prime_q2 <- mu_1999_prime_q2 %>%
  ...
  mutate(state_dest_sector_dest = paste(state_dest, sector_dest, sep="_")) %>%
  select(-state_dest, -sector_dest)
mu_1999_q2 <- spread(mu_1999_prime_q2, state_dest_sector_dest, rel, fill = NA, convert = TRUE,  drop = TRUE, sep = NULL)
...
mu_1999_prime_q3 <- mu_1999_prime_q3 %>%
  ...
  mutate(state_dest_sector_dest = paste(state_dest, sector_dest, sep="_")) %>%
  select(-state_dest, -sector_dest)
mu_1999_q3 <- spread(mu_1999_prime_q3, state_dest_sector_dest, rel, fill = NA, convert = TRUE,  drop = TRUE, sep = NULL)
...
mu_1999_prime_q4 <- mu_1999_prime_q4 %>%
  ...
  mutate(state_dest_sector_dest = paste(state_dest, sector_dest, sep="_")) %>%
  select(-state_dest, -sector_dest)
mu_1999_q4 <- spread(mu_1999_prime_q4, state_dest_sector_dest, rel, fill = NA, convert = TRUE,  drop = TRUE, sep = NULL)
