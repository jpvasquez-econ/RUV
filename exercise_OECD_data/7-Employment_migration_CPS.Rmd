...
if(sum(abs(as.matrix(rowSums(check)) - matrix(1, dim(check)[1], 1))) > epsilon) 
  stop(paste("mobility shares do not add to 1,", yr))
write_xlsx(final, paste("2-Final_Data//mu_", yr, "_CPS.xlsx", sep=""))
}
...
write_xlsx(mu, paste("2-Final_Data//mu_", yr, "_CPS.xlsx", sep=""))
...
write_xlsx(L, path = paste("2-Final_Data/L_", yr,"_CPS.xlsx", sep=""))
}
...
L <- read_excel(paste("2-Final_Data/L_", yr,"_CPS.xlsx", sep=""))
mu <- read_excel(paste("2-Final_Data/mu_", yr,"_CPS.xlsx", sep=""))
...
write_xlsx(table, path = paste("2-Final_Data/table_I_", yr,"_CPS.xlsx", sep=""))
}
